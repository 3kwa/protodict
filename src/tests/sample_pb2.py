...
_MESSAGEONEREQUIRED = _descriptor.Descriptor(
  name='MessageOneRequired',
  full_name='tests.MessageOneRequired',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='req', full_name='tests.MessageOneRequired.req', index=0,
...
_MESSAGEONEOPTIONAL = _descriptor.Descriptor(
  name='MessageOneOptional',
  full_name='tests.MessageOneOptional',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='opt', full_name='tests.MessageOneOptional.opt', index=0,
...
_MESSAGEONEREQUIRED.fields_by_name['req'].message_type = _MESSAGEONEOPTIONAL
...
DESCRIPTOR.message_types_by_name['MessageOneRequired'] = _MESSAGEONEREQUIRED
DESCRIPTOR.message_types_by_name['MessageOneOptional'] = _MESSAGEONEOPTIONAL
...
class MessageOneRequired(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _MESSAGEONEREQUIRED

  # @@protoc_insertion_point(class_scope:tests.MessageOneRequired)

class MessageOneOptional(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _MESSAGEONEOPTIONAL

  # @@protoc_insertion_point(class_scope:tests.MessageOneOptional)
